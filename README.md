...
### Changelog
**v1**
- Added timeout on connection to the database. @/include/classes/database.php (Note: If the timeout time is not entered in case the database connection fail it create an infinite loop that may underload the hosting).
...
- Choose the recaptcha theme. @config.php
...
- Fake statistics geral and guilds. @config.php
