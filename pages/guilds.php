<div class="container">
	...
	<ul class="nav nav-tabs">
		<li class="nav-item">
			<a class="nav-link" href="<?php print $site_url; ?>ranking/players"><img src="<?php print $site_url; ?>/themes/<?php print $theme_current_code; ?>/images/players.png" alt="<?php print $lang['players']; ?>" title="<?php print $lang['players']; ?>"> <?php print $lang['players']; ?></a>
		</li>
		<li class="nav-item">
			<a class="nav-link active" href="#"><img src="<?php print $site_url; ?>/themes/<?php print $theme_current_code; ?>/images/guilds.png" alt="<?php print $lang['guilds']; ?>" title="<?php print $lang['guilds']; ?>"> <?php print $lang['guilds']; ?></a>
		</li>
	</ul>
