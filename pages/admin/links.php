    ...
    <form action="" method="post">
		<?php foreach($site_general as $name => $link) if($name!='currency') { ?>
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="<?php if($name=='news') print 'number'; else if($name=='title') print 'text'; else if($name=='paypal') print 'email'; else print 'url'; ?>" class="form-control" name="<?php print $name; ?>" placeholder="<?php if($name=='news') print '5'; else if($name=='title') print 'Metin2CMS'; else if($name=='paypal') print 'contact@papix.work'; else print 'http://'; ?>" value="<?php print $link; ?>">
				</div>
			</div>
		<?php } ?>
