	...
	public function dataview($query, $search=NULL)
	{
		...
		if($rowCount>0)
		{
			...
			<tr>
				...
				<td><img src="<?php print $site_url; ?>themes/<?php print $theme_current_code; ?>/images/empire/<?php print $empire=get_player_empire($row['account_id']); ?>.jpg" alt="<?php print emire_name($empire); ?>" title="<?php print emire_name($empire); ?>"></td>
