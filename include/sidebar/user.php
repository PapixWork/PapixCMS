			...
			<div class="row">
				...
				<div class="col-md-10">
					<form class="form" role="form" method="post" action="<?php print $site_url; ?>users/login" accept-charset="UTF-8" id="login-nav">
						...
						<div class="form-group">
							<center><div class="g-recaptcha" data-theme="<?php print RECAPTCHA_THEME ?>" data-sitekey="<?php print RECAPTCHA_PUBLIC_KEY ?>" style="transform:scale(0.77);-webkit-transform:scale(0.77);transform-origin:0 0;-webkit-transform-origin:0 0;"></div></center>
						</div>
						<div class="form-group">
							<input type="submit" class="btn btn-primary btn-block" value="<?php print $lang['login']; ?>"<?php if($offline) print ' disabled'; ?>>
						</div>
					</form>
					<?php if(!$offline) { ?>
					<hr>
