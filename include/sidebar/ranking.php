	...
	<div class="widget widget-wide mod mod-main">
		<div class="bd eason">
			...
			<ul class="nav nav-tabs" role="tablist">
				<li class="nav-item">
					<a class="nav-link active" data-toggle="tab" href="#players" role="tab"><img src="<?php print $site_url; ?>/themes/<?php print $theme_current_code; ?>/images/players.png" alt="<?php print $lang['players']; ?>" title="<?php print $lang['players']; ?>"></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" data-toggle="tab" href="#guilds" role="tab"><img src="<?php print $site_url; ?>/themes/<?php print $theme_current_code; ?>/images/guilds.png" alt="<?php print $lang['guilds']; ?>" title="<?php print $lang['guilds']; ?>"></a>
				</li>
			</ul>
					...
					<table class="table table-sm table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td><img src="<?php print $site_url; ?>/themes/<?php print $theme_current_code; ?>/images/empire/<?php print $empire=get_player_empire($player['account_id']); ?>.jpg" alt="<?php print emire_name($empire); ?>" title="<?php print emire_name($empire); ?>"></td>
							</tr>
							<?php }
					...
					<table class="table table-sm table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td><img src="<?php print $site_url; ?>/themes/<?php print $theme_current_code; ?>/images/empire/<?php print $empire=get_guild_empire($guild['master']); ?>.jpg" alt="<?php print emire_name($empire); ?>" title="<?php print emire_name($empire); ?>"/></td>
							</tr>
							<?php }
